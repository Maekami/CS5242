...
Solve the following math problem clearly and step by step and put your final answer inside \\boxed{{ANSWER}} where ANSWER is just the final number or expression that solves the problem. 
