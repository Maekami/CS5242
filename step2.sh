...
NUM_GPUS=1
MODEL=deepseek-ai/DeepSeek-R1-Distill-Qwen-7B
MODEL_ARGS="pretrained=$MODEL,dtype=bfloat16,max_model_length=32768,gpu_memory_utilization=0.8,generation_parameters={max_new_tokens:16384,temperature:0.7,top_p:0.95}"
...
OUTPUT_DIR=data_test/evals/$MODEL
